...
" General {
    ...
    set modelines=0             " Turn off modeline to prevent exploits
...
" Vimdiff configuration {
    ...
    nnoremap ,n ]czz
    nnoremap ,N [czz
    nnoremap ,m :set modifiable<cr>:set noreadonly<cr>^G
...
" Vim UI_and_GUI {
   ...
   if has('gui_running')
        ...
        if &term == 'xterm' || &term == 'screen' || $COLORTERM == 'gnome-terminal'
...
" Key Mapping {
    ...
    nmap <silent> <leader>/ :set invhlsear
    ...
    " Map <Leader>0 in insert mode to quickly escape
    inoremap <Leader>0 <Esc>

    " Easier splitting and switching to new window
...
nnoremap <Leader>fu :Unite file<CR>
